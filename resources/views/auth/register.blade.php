<div class="container" id="container">
  <div class="form-container sign-up-container">
      <form method="POST" action="{{ route('register') }}">
          ...
          <div class="social-container">
              <!-- Puedes agregar botones de registro social aquí si lo deseas -->
          </div>
          ...
          <a class="forgot-password mt-4" href="{{ route('login') }}">
              {{ __('iniciar sesion') }}
          </a>
      </form>
  </div>
  <div class="form-container sign-in-container">
      <form action="{{ route('login') }}" method="GET">
          ...
          <div class="social-container">
              <!-- Botones sociales para iniciar sesión -->
          </div>

          <!-- Enlace para volver a la página de inicio de sesión -->
          <a href="welcome">
              <img src="img/4a40acbf485944beab405919fdc7ccfe-free.png" alt="Descripción de la imagen">
          </a>
      </form>
  </div>
  <div class="overlay-container">
      <div class="overlay">
          <div class="overlay-panel overlay-left">
              <h1>Registrate para acceder al</h1>
